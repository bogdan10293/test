...
namespace General.Data.Migrations
{
    ...
    [Migration("20201218141137_added_AddressModel")]
            ...
            modelBuilder.Entity("General.Domain.ViewModels.EmployeeServiceJoin", b =>
                {
                    ...
                    b.Property<int?>("KsCustomerEntityId")
                        .HasColumnType("int");

                    b.HasKey("EmployeeId", "ServiceId");

                    b.HasIndex("KsCustomerEntityId");
            ...
            modelBuilder.Entity("General.Domain.ViewModels.EmployeeServiceJoin", b =>
                {
                    ...
                    b.HasOne("General.Domain.ViewModels.KsStad.KsCustomerEntity", null)
                        .WithMany("EmployeeServiceJoins")
                        .HasForeignKey("KsCustomerEntityId");
